    ...
    <div className="contact" ref={ref}>
      <div className="contact-top">
        ...
        <button className="subscribe-button">
          Subscribe <ImArrowUpRight2 className="icon" />
        </button>
        </Container>
      </div>
        ...
        <Container>
          <div className="contact-bottom-top">
            <div className="contact-bottom-colA">
              <div className="colA-info">
                ...
                <p className="colA-contain">
                  Janak learns from each interaction, refining its knowledge and
                  enhancing its ability to assist users with their legal
                  queries.
                </p>
          ...
          <div className="contact-bottom-bottom">
            ...
            <div className="copyright">
              Copyright © 2023 Janak - All Rights Reserved.
            </div>
          </div>
        </Container>
      </div>
